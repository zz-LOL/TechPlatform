...
public class DCDate
{
    ...
    public String displayLocalDate(boolean showTime, Locale locale)
    {
        ...
        {
            return String.format("%4d-%s-%d %02d:%02d:%02d", getYear(), monthName, getDay(), getHour(), getMinute(), getSecond());
        }
        ...
        {
            return String.format("%4d-%s", getYear(), monthName);
        }
        else
        {
            return String.format("%4d-%s-%d", getYear(), monthName, getDay());
        }
    }
    ...
    public String displayUTCDate(boolean showTime, Locale locale)
    {
        ...
        if (showTime && granularity == DateGran.TIME)
        {
            return String.format("%4d-%s-%d %02d:%02d:%02d", getYearUTC(), monthName, getDayUTC(), getHourUTC(), getMinuteUTC(), getSecondUTC());
        }
        else if (granularity == DateGran.YEAR)
        {
            return String.format("%4d", getYearUTC());
        ...
        {
            return String.format("%4d-%s", getYearUTC(), monthName);
        }
        else
        {
            return String.format("%4d-%s-%d",  getYearUTC(), monthName, getDayUTC());
        }
    }
