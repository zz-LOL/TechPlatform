	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
		    <form action="<%= request.getContextPath() %>/mydspace" method="post">
                ...
                <input class="btn1 btn-primary2" style="font-size:18px;" type="submit" name="submit_new" value="<fmt:message key="jsp.mydspace.main.start.button"/>" />
                <input class="btn1 btn-primary2" style="font-size:18px;" type="submit" name="submit_own" value="<fmt:message key="jsp.mydspace.main.view.button"/>" />
		    </form>
