...
<dspace:layout style="popup" titlekey="jsp.tools.group-edit.title"
               parenttitlekey="jsp.administer"
               parentlink="/dspace-admin"
               nocache="true">
    <div class="content">

	<h3><fmt:message key="jsp.tools.group-edit.title"/> : <%=group.getName()%> (id: <%=group.getID()%>)
	...
	<div><label for="tgroup_name" class="pull-left">
