...
<dspace:layout style="submission" titlekey="jsp.tools.upload-bitstream.title"
    ...
    <form method="post" enctype="multipart/form-data" action="">
		...
		<div class="container row col-md-offset-5"><input class="btn1 btn-primary2" type="submit" name="submit" value="<fmt:message key="jsp.tools.upload-bitstream.upload"/>" /></div>
    </form>
