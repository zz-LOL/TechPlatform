...
<dspace:layout locbar="commLink" title="<%= name %>" feedData="<%= feedData %>">
    <!--<div class="well">-->
    <div class="row"><div class="col-md-8"><font style="font-family:Microsoft YaHei;font-size:36px;"><%= name %>
<%
...
%>
		<!--专题标题和统计logo<small><fmt:message key="jsp.collection-home.heading1"/></small>-->
      <a class="" href="<%= request.getContextPath() %>/handle/<%= collection.getHandle() %>/statistics"><img src="<%=request.getContextPath()%>/image/statics-logo.png"/></a>
      </font></div>
<%  if (logo != null) { %>
        <div class="col-md-4">
...
<% 	} %>
  ...
  <!--！！！！！！！！！！！导航栏，天蓝色的--->
<div class="" style="background-color:#FFF;display:none;" >
...
<%  if (submit_button)
    { %>
          <form class="form-group" action="<%= request.getContextPath() %>/submit" method="post">
			...
			<input class="btn2 btn-primary2 col-md-12" style="height:30px;" type="submit" name="submit" value="<fmt:message key="jsp.collection-home.submit.button"/>" />
          </form>
<%  } %>
...
<%  } else { %>
				...
				<input class="btn btn-sm btn-info" type="submit" style="font-family:Microsoft YaHei;" name="submit_subscribe" value="<fmt:message key="jsp.collection-home.subscribe"/>" />
<%  }
    if(feedEnabled)
    { %>
