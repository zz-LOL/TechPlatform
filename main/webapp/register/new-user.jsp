    ...
    <form class="form-horizontal" action="<%= request.getContextPath() %>/register" method="post">
        ...
        <input type="hidden" name="step" value="<%= RegisterServlet.ENTER_EMAIL_PAGE %>"/>
                        ...
                        <div class="row col-md-offset-5">
							...
							<input class="btn1 btn-primary2" style="font-size:16px;width:103px;height:26px" type="submit" name="submit" value="<fmt:message key="jsp.register.new-user.register.button"/>" />
						</div>
    </form>
