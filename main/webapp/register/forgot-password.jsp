        ...
        <input type="hidden" name="step" value="<%= RegisterServlet.ENTER_EMAIL_PAGE %>"/>
					...
					<div class="row">
        				<div class="col-md-6">
							...
							<input class="btn2 btn-primary2"style="margin-left:70%;height:30px;width:120px;" type="submit" name="submit" value="<fmt:message key="jsp.register.forgot-password.forgot.button"/>" />
						</div>
					</div>
    </form>
