...
%>
	<div class="col-md-offset-5">
	   ...
	   <input class="btn1 btn-primary2" style="margin-top:20px;font-size:18px;width:200px;height:30px;" type="submit" name="submit" value="<fmt:message key="jsp.register.edit-profile.update.button"/>" />
	 </div>
    </form>
</dspace:layout>
