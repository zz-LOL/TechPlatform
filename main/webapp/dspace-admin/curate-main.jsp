...
<dspace:layout style="popup" titlekey="jsp.dspace-admin.curate.main.title"
               navbar="admin"
               locbar="link"
...
%>
  ...
  <div class="input-group">
    ...
    <input class="btn find" type="submit" name="submit_main_curate" value="<fmt:message key="jsp.tools.curate.perform.button"/>" />
    <input class="btn find" type="submit" name="submit_main_queue" value="<fmt:message key="jsp.tools.curate.queue.button"/>" />
    <input class="btn-cancel" type="submit" name="submit_main_cancel" value="<fmt:message key="jsp.dspace-admin.general.cancel"/>" />
  </div>
</form>
</div>
</dspace:layout>
