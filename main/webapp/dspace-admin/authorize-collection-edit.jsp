...
<dspace:layout style="popup" titlekey="jsp.dspace-admin.authorize-collection-edit.title"
               parenttitlekey="jsp.administer"
               parentlink="/dspace-admin"
               nocache="true">
    <div class="content">

		<h3><fmt:message key="jsp.dspace-admin.authorize-collection-edit.policies">
