...
<dspace:layout style="popup" titlekey="jsp.dspace-admin.authorize-item-edit.title"
               parenttitlekey="jsp.administer"
               parentlink="/dspace-admin"
               nocache="true">
    <div class="content">

	<h3><fmt:message key="jsp.dspace-admin.authorize-item-edit.policies">
  ...
  <div class="panel-body">
    <form method="post" action="">
      <div class="row col-md-offset-4">
          ...
          <input class="btn1 btn-primary2" style="font-size:18px;" type="submit" name="submit_item_add_policy" value="<fmt:message key="jsp.dspace-admin.general.addpolicy"/>" />
      </div>
    </form>
    <br/>
	...
	<div class="panel panel-info">
        ...
        <form method="post" action="">
      		<div class="row col-md-offset-4">
                ...
                <input class="btn1 btn-primary2" style="font-size:18px;" type="submit" name="submit_bundle_add_policy" value="<fmt:message key="jsp.dspace-admin.general.addpolicy"/>" />
            </div>
        </form>
        <br/> 
        ...
        <div class="panel-body">    
            <form method="post" action="">
                <div class="row col-md-offset-4">
                    ...
                    <input class="btn1 btn-primary2" style="font-size:18px;" type="submit" name="submit_bitstream_add_policy" value="<fmt:message key="jsp.dspace-admin.general.addpolicy"/>" />
                </div>
            </form>
            <br/>
