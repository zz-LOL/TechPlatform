...
<dspace:layout style="popup" titlekey="jsp.dspace-admin.eperson-main.title"
    ...
    <h3><fmt:message key="jsp.dspace-admin.eperson-main.heading"/>
    ...
    <h5><fmt:message key="jsp.dspace-admin.eperson-main.choose"/></h5>
...
<%  } %>    
    <form name="epersongroup" method="post" action="">    
            ...
            <%-- <input type="submit" name="submit_add" value="Add EPerson..."> --%>
            	<input class="btn btn-success col-md-2" type="submit" name="submit_add" value="<fmt:message key="jsp.dspace-admin.eperson-main.add"/>" />
			</div>
			<br/>
