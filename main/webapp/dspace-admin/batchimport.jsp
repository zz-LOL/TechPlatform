...
%>
    ...
    <form method="post" action="<%= request.getContextPath() %>/dspace-admin/batchimport" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label for="inputType"><fmt:message key="jsp.dspace-admin.batchmetadataimport.selectinputfile"/></label><br/>
	        <select class="up-in" name="inputType" id="import-type">
			<%
	...
	%>      </select>
		...
		<div class="form-group" id="input-url">
			...
			<input type="text" name="zipurl" class="up-in"/>
        </div>
        
        <div class="form-group" id="input-file">
			<label for="file"><fmt:message key="jsp.dspace-admin.batchmetadataimport.selectfile"/></label><br/>
        ...
        <div class="form-group">
            ...
            <select class="up-in" name="collection" id="owning-collection-select">
...
%> 			
 ...
 %>           	
        ...
        <div class="form-group" id="other-collections-div" style="<%= displayValue %>">
            ...
            <select class="up-in" name="collections" multiple style="height:150px" id="other-collections-select">
 <% 
 		for (Collection collection : collections){
