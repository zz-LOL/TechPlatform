...
<%
    ...
    {
%>
            <div class="row"><input class="btn1 btn-primary2 col-md-2 col-md-offset-5" style="min-height: 30px;min-width: 200px;" type="submit" name="submit_more" value="<fmt:message key="jsp.submit.upload-file-list.button4"/>" /></div>
<%
    }
%>
<br/>
