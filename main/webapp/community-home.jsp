...
<!--<div class="well">-->
 <div class="row" style="width:848px;"><div class="col-md-8"><font style="font-family:Microsoft YaHei;font-size:24px;"><%= name %>
        <%
...
%>
        ...
        <a class="" href="<%= request.getContextPath() %>/handle/<%= community.getHandle() %>/statistics"><img src="<%=request.getContextPath()%>/image/statics-logo.png"/></a>
...
<p class="copyrightText"><%= copyright %></p>
 ...
 <!--！！！！！！！！！！！导航栏，天蓝色的--->
<div class="" style="background-color:#FFF; width:75%; height:36px;display:none;" >
...
<div class="row"  style="display:none">
    ...
    <div class="col-md-8"  style="z-index:1099 ;">
...
<div class=" pull-right" style="display:none;width:20%; z-index:1100; border:1px solid #9bc2e5;border-bottom-width:0px;">
	<div class="panel-heading"><img src="<%=request.getContextPath()%>/image/232.png" style="margin-left:-10px;">&nbsp&nbsp<fmt:message key="jsp.community-home.heading2"/></div>
...
%>
			<div class="list-group-item2 ">
            	 <h4 class="list-group-item-heading"><a href="<%= request.getContextPath() %>/handle/<%= collections[k].getHandle() %>">
	                <%= collections[k].getMetadata("name") %></a>
<%          	
				if (ConfigurationManager.getBooleanProperty("webui.strengths.show"))
                {
%>
			<div class="col-md-12">
                    [<%= ic.getCount(collections[k]) %>]
            </div>
<%
                }
%>  
...
%>        
    ...
    <!--！！！！！！！！！！！！！！！！！！社区最近跟新内容-->
    <div class="MM pull-left" style="display:none;/*border:1px solid #000; margin-top:30px; width:78%; height:1000px;*/" >
