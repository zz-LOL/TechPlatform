...
<!--<h3 class="facets"><fmt:message key="jsp.search.facet.refine" /></h3>-->
         ...
         <div class="facets pull-right" style="width:20%;border:1px solid #9bc2e5;border-top-width:0px">
<%
	for (DiscoverySearchFilterFacet facetConf : facetsConf)
	{
    	String f = facetConf.getIndexFieldName();
	    ...
	    <div class="panel-heading"><img src="<%=request.getContextPath()%>/image/232.png" style="margin-left:-10px;">&nbsp&nbsp<fmt:message key="<%= fkey %>" /></div>
	    <ul class="list-group"><%
	    int idx = 1;
