...
<dspace:layout style="popup" titlekey="browse.page-title">
...
<div class="" style="width:100%;;margin-left: -2px;">
...
<% 
	...
	{
%>
	<a class="pull-left"style="margin-left:10%;" href="<%= prev %>"><fmt:message key="browse.single.prev"/></a>&nbsp;
<%
	}
%>
...
<%
	...
	{
%>
	&nbsp;<a class="pull-right" style="margin-right:18.5%;" href="<%= next %>"><fmt:message key="browse.single.next"/></a>
<%
	}
%>
	</div>
<div style="margin-left: 10%;width:40%;float: left;background-color: #f8f8f8;">
<ul class="list-group">
<%
...
<div style="float:right;width:5%;margin-right:20%;">
...
%>	
        ...
        <a class="/*label1 label-primary1*/" href="<%= sharedLink %>&amp;starts_with=0">0-9</a>-->
<br/>
<%
	    for (char c = 'A'; c <= 'Z'; c++)
	    {
%>
        <a class="/*label1 label-primary1*/"  href="<%= sharedLink %>&amp;starts_with=<%= c %>"><%= c %></a><br/>
<%
	    }
%>
