	...
	<div class="panel-body">
     <form name="loginform" class="form-horizontal" id="loginform" method="post" action="<%= request.getContextPath() %>/password-login">  
	  ...
	  <p><fmt:message key="jsp.components.login-form.enter"/></p>
        ...
        <div class="row">
        <div class="col-md-6">
        	<input type="submit" class="btn1 btn-primary2 pull-right" style="font-size:16px;min-width:53px;min-height:26px;" name="login_submit" value="<fmt:message key="jsp.components.login-form.login"/>" tabindex="3" />
        </div>
        </div>
